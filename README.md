...
> * [Connector Function](src/main/java/io/camunda/MQTT/MyConnectorFunction.java) (rename, implement, update
...
1. Run `io.camunda.MQTT.LocalConnectorRuntime` to start your connector.
